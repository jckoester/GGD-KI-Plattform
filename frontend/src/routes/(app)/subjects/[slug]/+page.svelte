...
<div class="h-full overflow-y-auto p-6 max-w-3xl">
        ...
        {#if isTeacher && myGroupsForSubject.length > 0}
            <div class="flex flex-wrap gap-2 mb-4">
                {#each myGroupsForSubject as group (group.id)}
                    {@const isActive =
                        $page.url.pathname ===
                        `/subjects/${subject.slug}/groups/${group.id}`}
                    <a
        ...
        {#if isTeacher}
            <nav
                class="flex gap-1 border-b border-light-ui-2 dark:border-dark-ui-2 mb-6 -mx-6 px-6"
            >
        ...
        {#if activeTab === "uebersicht" || !isTeacher}
                        ...
                        <table class="w-full text-left border-collapse">
                           ...
                           hover:bg-light-ui-2 dark:hover:bg-dark-ui-2 transition-colors cursor-pointer"
                                    ...
                                    >
                                        ...
                                        <td
                                            class="px-4 py-3 text-sm text-light-tx-3 dark:text-dark-tx-3 whitespace-nowrap"
                                        >
            ...
            <section>
                ...
                <p class="text-sm text-light-tx-2 dark:text-dark-tx-2">
                    Dieser Bereich wird in Phase 5 mit verknüpften Dokumenten
                    und Vektoren befüllt.
                </p>
            </section>
